...
import org.blackbox.setupwizard.R;

import lineageos.hardware.LineageHardwareManager;
import lineageos.providers.LineageSettings;

public class BlackboxSettingsActivity extends BaseSetupWizardActivity {

    public static final String TAG = BlackboxSettingsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String metricsHelpImproveBlackbox =
                getString(R.string.services_help_improve_cm, getString(R.string.os_name));
        String metricsSummary = getString(R.string.services_metrics_label,
                metricsHelpImproveBlackbox, getString(R.string.os_name));
        final SpannableStringBuilder metricsSpan = new SpannableStringBuilder(metricsSummary);
        metricsSpan.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD),
                0, metricsHelpImproveBlackbox.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    protected int getLayoutResId() {
        return R.layout.setup_blackbox_settings;
    }
