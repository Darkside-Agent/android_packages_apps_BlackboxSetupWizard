...
adb root
wait ${!}
adb shell pm enable org.blackbox.setupwizard/org.blackbox.setupwizard.SetupWizardExitActivity || true
wait ${!}
adb shell pm enable com.google.android.setupwizard/com.google.android.setupwizard.SetupWizardExitActivity || true
wait ${!}
sleep 1
adb shell am start org.blackbox.setupwizard/org.blackbox.setupwizard.SetupWizardExitActivity || true
wait ${!}
sleep 1
